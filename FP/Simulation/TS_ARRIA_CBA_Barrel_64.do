# ===========================
# TS_ARRIA_CBA_Barrel_64.do
# ===========================

transcript file ""
# --- Compile design and testbench ---
vcom -work work -2008 -explicit -stats=none ModelSim/Questa/ARRIA_CBA_Barrel_64.vho
...
vsim -t 100ps -gui -sdftyp /TB_ExecUnit/DUT=ModelSim/Questa/ARRIA_CBA_Barrel_64.sdo work.CFG_TIMING -gTestVectorFile=""TestVectors/Exec64.tvs""
# Set up wave window
do wave.do
transcript file ../Documentation/OutputFiles/TS_ARRIA_CBA_Barrel_64_Transcript.txt
transcript quietly
