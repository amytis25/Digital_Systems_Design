...
vsim -t 100ps -gui work.CFG_FUNC_CBA_Barrel

# Set up wave window
do wave.do
transcript file ../Documentation/OutputFiles/FS_CBA_Barrel_Transcript.txt
transcript quietly

echo "Running functional simulation for the execution unit using Carry-Bypass Adder and Barrel Shifting unit..."
run -all
