...
vsim -t 100ps -gui work.CFG_FUNC_RCA_Barrel     -gN=64     -gTestVectorFile=""TestVectors/Exec32.tvs""

# Set up wave window
do wave.do
transcript file ../Documentation/OutputFiles/FS_RCA_Barrel_32_Transcript.txt
transcript quietly

echo "Running functional simulation for the 32-bit execution unit using Ripple-Carry Adder and Barrel Shifting unit..."
run -all

echo "=== Functional Simulation for the 32-bit execution unit using Ripple-Carry Adder and Barrel Shifting unit Complete ==="
transcript off
