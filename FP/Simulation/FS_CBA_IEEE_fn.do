...
vsim -t 100ps -gui work.CFG_FUNC_CBA_IEEE_fn

# Set up wave window
do wave.do
transcript file ../Documentation/OutputFiles/FS_CBA_IEEE_fn_Transcript.txt
transcript quietly

echo "Running functional simulation for the execution unit using Carry-Bypass Adder and Shifting unit that uses IEEE functions..."
run -all
