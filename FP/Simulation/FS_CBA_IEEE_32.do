...
vsim -t 100ps -gui work.CFG_FUNC_CBA_IEEE     -gN=64     -gTestVectorFile=""TestVectors/Exec32.tvs""

# Set up wave window
do wave.do
transcript file ../Documentation/OutputFiles/FS_CBA_IEEE_32_Transcript.txt
transcript quietly
