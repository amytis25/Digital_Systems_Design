...
vsim -t 100ps -gui work.CFG_FUNC_RCA_IEEE     -gN=64     -gTestVectorFile=""TestVectors/Exec128.tvs""

# Set up wave window
do wave.do
transcript file ../Documentation/OutputFiles/FS_RCA_IEEE_128_Transcript.txt
transcript quietly

echo "Running functional simulation for the 128-bit execution unit using Ripple-Carry Adder and Shifting unit that uses IEEE functions..."
run -all

echo "=== Functional Simulation for the 128-bit execution unit using Ripple-Carry Adder and Shifting unit that uses IEEE functions Complete ==="
transcript off
