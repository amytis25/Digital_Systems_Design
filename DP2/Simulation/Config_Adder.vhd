...
configuration CFG_FUNC_RCA of TB_Adder is
  for behavioural
    for DUT : EN_Adder use entity work.EN_Adder(RCA); end for;
  end for;
end configuration;

configuration CFG_FUNC_CSA of TB_Adder is
  for behavioural
    for DUT : EN_Adder use entity work.EN_Adder(CSA); end for;
  end for;
end configuration;

configuration CFG_FUNC_LACGT of TB_Adder is
  for behavioural
    for DUT : EN_Adder use entity work.EN_Adder(LACGT); end for;
  end for;
end configuration;

configuration CFG_FUNC_BKA of TB_Adder is
  for behavioural
    for DUT : EN_Adder use entity work.EN_Adder(BKA); end for;
  end for;
end configuration;
...
configuration CFG_TIMING_RCA of TB_Adder is
  for behavioural
    for DUT : EN_Adder use entity work.EN_Adder(structure); end for;
  end for;
end configuration;
