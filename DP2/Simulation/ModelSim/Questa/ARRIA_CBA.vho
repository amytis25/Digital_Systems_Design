...
-- Equation(s):
-- \S_internal~63_combout\ = ( \GEN_BLOCKS:15:LACG_INST|C[3]~1_combout\ & ( !\A[63]~input_o\ $ (\B[63]~input_o\) ) ) # ( !\GEN_BLOCKS:15:LACG_INST|C[3]~1_combout\ & ( !\A[63]~input_o\ $ (!\B[63]~input_o\ $ (((\block_carry_in[15]~33_combout\ & 
...
-- Equation(s):
-- \Ovfl~0_combout\ = ( \GEN_BLOCKS:15:LACG_INST|C[3]~1_combout\ & ( (!\A[63]~input_o\ & !\B[63]~input_o\) ) ) # ( !\GEN_BLOCKS:15:LACG_INST|C[3]~1_combout\ & ( (!\A[63]~input_o\ & (\block_carry_in[15]~33_combout\ & (\GEN_BLOCKS:15:LACG_INST|Pout~0_combout\ 
-- & !\B[63]~input_o\))) # (\A[63]~input_o\ & (\B[63]~input_o\ & ((!\block_carry_in[15]~33_combout\) # (!\GEN_BLOCKS:15:LACG_INST|Pout~0_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010000110010000001000011001011001100000000001100110000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_block_carry_in[15]~33_combout\,
